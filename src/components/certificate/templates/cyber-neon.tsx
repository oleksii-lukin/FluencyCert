      ...
      <div className="flex flex-col p-10 md:p-14">
        ...
        <div className="mb-8 grid grid-cols-2 gap-4">
          <div className="cyber-panel-strong p-5">
            <p className="font-mono text-xs font-medium text-[#22C55E]/50 uppercase tracking-wider">Speaking Clubs</p>
            <p className="mt-1.5 text-2xl font-bold text-white">{speakingClubsCount}</p>
          </div>
          {hoursParticipated != null ? (
            <div className="cyber-panel-strong p-5">
              <p className="font-mono text-xs font-medium text-[#22C55E]/50 uppercase tracking-wider">Hours Participated</p>
              <p className="mt-1.5 text-2xl font-bold text-white">{hoursParticipated}</p>
            </div>
          ) : (
            <div className="cyber-panel-strong p-5">
              <p className="font-mono text-xs font-medium text-[#22C55E]/50 uppercase tracking-wider">Certificate ID</p>
        ...
        {adminFeedback && (
          <div className="cyber-panel mb-8 border-l-[3px] border-l-[#22C55E] p-5">
            <p className="font-mono mb-1 text-xs font-medium text-[#22C55E]/50 uppercase tracking-wider">Administrator&apos;s Note</p>
        ...
        <div className="mt-auto flex items-end justify-between">
          <div>
            <p className="font-mono text-xs font-medium text-[#22C55E]/50 uppercase tracking-wider">Issued on</p>
          ...
          <div className="text-right">
            <p className="font-mono text-xs font-medium text-[#22C55E]/50 uppercase tracking-wider">ID</p>
