      ...
      <div className="flex flex-col p-10 md:p-14">
        ...
        <div className="mb-8 flex items-start justify-between">
          <div>
            ...
            <h1 className="font-mono mt-1 text-2xl font-black tracking-tight uppercase md:text-3xl">
              Certificate of<br />English Proficiency
            </h1>
          </div>
        ...
        <div className="mb-8 grid grid-cols-2 gap-4">
          <div className="neubrutal-stat p-5">
            <p className="font-mono text-xs font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider">Speaking Clubs</p>
            <p className="mt-1.5 text-2xl font-black text-black dark:text-white">{speakingClubsCount}</p>
          </div>
          {hoursParticipated != null ? (
            <div className="neubrutal-stat p-5">
              <p className="font-mono text-xs font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider">Hours Participated</p>
              <p className="mt-1.5 text-2xl font-black text-black dark:text-white">{hoursParticipated}</p>
            </div>
          ) : (
            <div className="neubrutal-stat p-5">
              <p className="font-mono text-xs font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider">Certificate ID</p>
        ...
        {adminFeedback && (
          <div className="neubrutal-panel mb-8 border-l-[6px] border-l-[#FF5252] p-5">
            <p className="font-mono mb-1 text-xs font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider">Administrator&apos;s Note</p>
        ...
        <div className="mt-auto flex items-end justify-between">
          <div>
            <p className="font-mono text-xs font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider">Issued on</p>
          ...
          <div className="text-right">
            <p className="font-mono text-xs font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider">ID</p>
