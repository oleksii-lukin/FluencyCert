...
function ModernGlassCertificate({
  fullName,
  englishLevel,
  speakingClubsCount,
  hoursParticipated,
      ...
      <div className="relative z-10 flex flex-col p-10 md:p-14">
        ...
        <div className="mb-8 flex items-start justify-between">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-bold tracking-tight md:text-3xl" style={{ fontFamily: "var(--font-serif)" }}>
              Certificate of <span className="modern-glass-gold-text">English Proficiency</span>
            </h1>
          </div>
        ...
        <div className="mb-8 grid grid-cols-2 gap-4">
          <div className="modern-glass-panel-strong rounded-xl p-5">
            <p className="text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-wider">Speaking Clubs</p>
            <p className="mt-1.5 text-2xl font-bold text-slate-900 dark:text-white">{speakingClubsCount}</p>
          </div>
          {hoursParticipated != null ? (
            <div className="modern-glass-panel-strong rounded-xl p-5">
              <p className="text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-wider">Hours Participated</p>
              <p className="mt-1.5 text-2xl font-bold text-slate-900 dark:text-white">{hoursParticipated}</p>
            </div>
          ) : (
            <div className="modern-glass-panel-strong rounded-xl p-5">
              <p className="text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-wider">Certificate ID</p>
        ...
        {adminFeedback && (
          <div className="modern-glass-panel mb-8 rounded-xl border-l-4 border-[#CA8A04]/50 p-5">
            <p className="mb-1 text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-wider">Administrator&apos;s Note</p>
        ...
        <div className="mt-auto flex items-end justify-between">
          <div>
            <p className="text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-wider">Issued on</p>
