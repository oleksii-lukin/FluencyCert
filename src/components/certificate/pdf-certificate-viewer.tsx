...
export function PdfCertificateViewer({
      ...
      try {
        ...
        for (const field of fields) {
          ...
          try {
            ...
            const font = await pdfDoc.embedFont(fieldFontCache[fontKey])
            ...
            // field may not exist in PDF — skip
          }
        }
  ...
  }, [templateFileUrl, fields, certificateData, customValues, certificateUrl])
