...
const steps = [
  {
    ...
    color: "bg-bright-sky/15 text-bright-sky",
  },
  {
    ...
    color: "bg-bright-sky/20 text-bright-sky",
  },
  {
...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="relative bg-gradient-to-b from-white via-bright-sky/[0.02] to-white px-4 py-20 md:py-28">
        ...
        <div className="relative grid gap-8 md:grid-cols-3">
          {steps.map((step, i) => (
            <div key={step.title} className="group relative">
              <div className="flex flex-col items-center rounded-2xl border border-bright-sky/15 bg-gradient-to-b from-white to-bright-sky/[0.03] p-8 text-center shadow-sm shadow-bright-sky/5 transition-all duration-300 hover:border-bright-sky/30 hover:shadow-lg hover:shadow-bright-sky/15">
                ...
                <div className="mb-3 flex items-center gap-2">
                  <span className="flex size-6 items-center justify-center rounded-full bg-bright-sky/15 text-xs font-bold text-bright-sky">
                    {i + 1}
                  </span>
                </div>
                <h3 className="text-lg font-semibold text-graphite">{step.title}</h3>
                <p className="mt-2 text-sm leading-relaxed text-graphite/55">{step.description}</p>
              </div>

              {i < steps.length - 1 && (
                <div className="absolute top-1/3 -right-4 hidden text-bright-sky/30 md:block">
