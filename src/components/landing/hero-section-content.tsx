            ...
            <div className="mt-12 flex flex-wrap items-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-graphite/50 dark:text-snow/50">{certificatesIssued}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex size-10 items-center justify-center rounded-xl bg-bright-sky/15 dark:bg-bright-sky/20">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-graphite/50 dark:text-snow/50">{activeMembers}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex size-10 items-center justify-center rounded-xl bg-bright-sky/15 dark:bg-bright-sky/20">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-graphite/50 dark:text-snow/50">{reactionsSent}</p>
                </div>
              </div>
            </div>
          </div>
